...
export const CANDIDATES = [
  ...
  {id:"priya-s",name:"Priya Sharma",city:"Pune",domain:"CS",specialization:"Data Science",tier:"Practitioner",tfes:82,simulations:31,projects:17,badges:6,earned:87500,rating:4.8,available:true,aiMatch:81,skills:["Python","TensorFlow","SQL","Pandas","XGBoost","Sklearn","BERT"],scores:{technical:85,domain:82,problem:79,comms:84,collab:81,consistency:78},progression:[58,62,66,68,71,74,76,78,79,80,81,82],badges:[],simulations:[],reviews:[]},
  {id:"vikram-r",name:"Vikram Reddy",city:"Hyderabad",domain:"Mechanical",specialization:"FEA/CAD",tier:"Practitioner",tfes:79,simulations:24,projects:11,badges:5,earned:63000,rating:4.7,available:true,aiMatch:72,skills:["SolidWorks","ANSYS","AutoCAD","CATIA","FEA","GD&T"],scores:{technical:80,domain:84,problem:75,comms:72,collab:78,consistency:74},progression:[55,59,62,64,67,70,72,74,75,77,78,79],badges:[],simulations:[],reviews:[]},
  {id:"deepa-k",name:"Deepa Kumar",city:"Chennai",domain:"EEE",specialization:"Power Systems",tier:"Expert",tfes:84,simulations:38,projects:19,badges:7,earned:91000,rating:4.9,available:true,aiMatch:88,skills:["Load Flow","ETAP","Relay Coordination","SCADA","PLC","MATLAB"],scores:{technical:87,domain:90,problem:82,comms:80,collab:85,consistency:82},progression:[60,63,67,70,73,75,77,79,80,82,83,84],badges:[],simulations:[],reviews:[]},
  {id:"ravi-t",name:"Ravi Teja",city:"Coimbatore",domain:"CS",specialization:"Full Stack",tier:"Practitioner",tfes:76,simulations:21,projects:9,badges:4,earned:54000,rating:4.6,available:true,aiMatch:78,skills:["React","Node.js","PostgreSQL","Docker","TypeScript","REST"],scores:{technical:78,domain:76,problem:74,comms:79,collab:77,consistency:73},progression:[52,56,59,62,65,67,69,71,73,74,75,76],badges:[],simulations:[],reviews:[]},
  {id:"kavya-m",name:"Kavya Menon",city:"Bangalore",domain:"DS",specialization:"ML/AI",tier:"Expert",tfes:88,simulations:29,projects:16,badges:6,earned:138000,rating:4.9,available:true,aiMatch:91,skills:["XGBoost","BERT","MLflow","PyTorch","SQL","Spark"],scores:{technical:90,domain:92,problem:88,comms:82,collab:86,consistency:85},progression:[63,67,70,73,76,78,80,82,84,86,87,88],badges:[],simulations:[],reviews:[]},
  {id:"suresh-p",name:"Suresh Pillai",city:"Madurai",domain:"ECE",specialization:"IoT",tier:"Practitioner",tfes:74,simulations:18,projects:8,badges:3,earned:48000,rating:4.5,available:false,aiMatch:68,skills:["LoRaWAN","Zigbee","MQTT","Node-RED","Raspberry Pi","Python"],scores:{technical:75,domain:77,problem:72,comms:70,collab:74,consistency:71},progression:[50,53,56,59,61,64,66,68,70,71,73,74],badges:[],simulations:[],reviews:[]},
  {id:"anitha-r",name:"Anitha Rajan",city:"Trichy",domain:"EEE",specialization:"Automation",tier:"Expert",tfes:81,simulations:26,projects:13,badges:5,earned:72000,rating:4.7,available:true,aiMatch:75,skills:["PLC","SCADA","DCS","HMI","Siemens S7","Allen Bradley"],scores:{technical:83,domain:85,problem:79,comms:77,collab:81,consistency:79},progression:[56,60,63,66,68,71,73,75,77,78,80,81],badges:[],simulations:[],reviews:[]},
  {id:"karthik-s",name:"Karthik Suresh",city:"Chennai",domain:"Robotics",specialization:"ROS/Control",tier:"Expert",tfes:86,simulations:33,projects:18,badges:7,earned:110000,rating:4.8,available:false,aiMatch:85,skills:["ROS2","Python","OpenCV","SLAM","Gazebo","C++"],scores:{technical:88,domain:87,problem:85,comms:80,collab:83,consistency:82},progression:[61,65,68,71,74,77,79,81,82,84,85,86],badges:[],simulations:[],reviews:[]},
  {id:"meera-v",name:"Meera Varma",city:"Pune",domain:"AI/ML",specialization:"Deep Learning",tier:"Master",tfes:91,simulations:42,projects:22,badges:9,earned:162000,rating:4.9,available:true,aiMatch:96,skills:["PyTorch","TensorFlow","CUDA","LLM","RAG","Diffusion Models"],scores:{technical:94,domain:93,problem:91,comms:87,collab:90,consistency:89},progression:[67,71,74,77,80,82,84,86,88,89,90,91],badges:[],simulations:[],reviews:[]},
  {id:"dinesh-b",name:"Dinesh Bhat",city:"Ahmedabad",domain:"Civil",specialization:"Structural",tier:"Practitioner",tfes:72,simulations:16,projects:7,badges:3,earned:41000,rating:4.4,available:true,aiMatch:62,skills:["AutoCAD","STAAD Pro","ETABS","SAP2000","MS Project"],scores:{technical:73,domain:76,problem:70,comms:71,collab:72,consistency:69},progression:[48,51,54,57,60,62,64,66,68,69,71,72],badges:[],simulations:[],reviews:[]},
  {id:"pooja-n",name:"Pooja Nair",city:"Bangalore",domain:"Cloud",specialization:"DevOps",tier:"Expert",tfes:83,simulations:27,projects:14,badges:6,earned:96000,rating:4.8,available:true,aiMatch:82,skills:["AWS","Kubernetes","Terraform","CI/CD","Docker","Prometheus"],scores:{technical:85,domain:84,problem:82,comms:84,collab:83,consistency:80},progression:[59,62,65,68,71,73,75,77,79,80,82,83],badges:[],simulations:[],reviews:[]}
]
